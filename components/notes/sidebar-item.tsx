...
const SidebarItem = ({ name, description, tags, isStarred, isCurrent=false }: SidebarItemProps) => {
    return (
        <div className={`flex items-center gap-4 min-w-0 transition-all hover:bg-foreground/30 active:bg-foreground/60 p-2 cursor-pointer rounded-xl ${ isCurrent && "bg-foreground pointer-events-none" }`}>
